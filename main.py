...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--odir", help="result image name", default="res")
    parser.add_argument("-f", "--flist", help="specific test sample", default=0)
    ...
    if flist:
        with open(flist, "r") as f:
            flines = f.readlines()
            flines = [ele.strip() for ele in flines]
    for name in names:
